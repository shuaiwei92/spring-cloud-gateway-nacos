...
//        BeanUtil.copyProperties(client, oAuth2ClientDTO);
        OAuth2ClientDTO oAuth2ClientDTO = new OAuth2ClientDTO();
        oAuth2ClientDTO.setClientId("client");
        oAuth2ClientDTO.setClientSecret("123456");
        oAuth2ClientDTO.setScope("all");
        oAuth2ClientDTO.setAuthorizedGrantTypes("password,authorization_code,refresh_token");
        oAuth2ClientDTO.setAccessTokenValidity(3600);
        oAuth2ClientDTO.setRefreshTokenValidity(7200);
        oAuth2ClientDTO.setAutoapprove("true");
