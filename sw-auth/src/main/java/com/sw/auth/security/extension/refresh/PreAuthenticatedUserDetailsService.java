package com.sw.auth.security.extension.refresh;

import com.sw.common.constant.SecurityConstants;
import com.sw.common.enums.AuthenticationMethodEnum;
import com.sw.common.web.util.RequestUtils;
...
public class PreAuthenticatedUserDetailsService <T extends Authentication> implements AuthenticationUserDetailsService<T>, InitializingBean {
     ...
     *
     * @see com.sw.auth.security.config.AuthorizationServerConfig#tokenServices(AuthorizationServerEndpointsConfigurer)
     */
